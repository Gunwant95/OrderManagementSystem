...
namespace SchoolManagement.SchoolDataSetTableAdapters {
...
SELECT ID, username, password FROM login WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::SchoolManagement.Properties.Settings.Default.SchoolConnectionString;
        }
